    ...
    <div className="p-4 bg-gh-surface border-b border-gh-border hover:bg-gh-surface2/40 transition-colors flex items-start gap-3">
      ...
      <div className="flex-1 flex flex-col gap-1.5 min-w-0">
        <div className="flex items-center gap-2 flex-wrap min-w-0">
          <a href="#" className="text-sm font-bold text-white hover:text-gh-blue hover:underline leading-snug">
            {issue.title}
          </a>
        ...
        {/* Skill Match & Impact details */}
        <div className="flex items-center gap-6 mt-2 flex-wrap select-none border-t border-gh-border/30 pt-2.5">
          {issue.skillMatch > 0 && (
      ...
      {issue.comments > 0 && (
        <div className="flex items-center gap-1 text-xs text-gh-muted shrink-0 select-none hover:text-gh-blue cursor-pointer">
